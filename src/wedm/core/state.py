...
class EDMState:
    ...
    # Dielectric
    dielectric_conductivity: float = 0.0 # [S m⁻¹] Conductivity of the dielectric material
    dielectric_temperature: float = 0.0 # [K] Temperature of the dielectric material
    debris_concentration: float = 0.0 # [kg m⁻³] Concentration of debris in the dielectric
    dielectric_flow_rate: float = 0.0 # [m³ s⁻¹] Flow rate of the dielectric
    ionized_channel: Optional[Tuple[float, int]] = None # (y-loc, duration) of the ionized channel
